...
MIN_MA_SPREAD_PCT = 0.15     # MA5 vs MA30 must differ by at least this % to count as a real trend
RSI_BUY_CEILING = 60         # require RSI clearly below this for BUY (not just <70)
RSI_SELL_FLOOR = 40          # require RSI clearly above this for SELL (not just >30)
CONFIRMATION_STREAK = 3      # same raw signal must repeat this many cycles before alerting
...
def fetch_price():
    ...
    try:
        ...
        # CoinCap v3 wraps the asset object under "data"
        asset = data.get("data")
...
def generate_signal():
    ...
    # Require a real spread between MA5 and MA30, not just a technical crossover
